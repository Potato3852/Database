#############################################################################
# Makefile for building: student_database
# Generated by qmake (3.1) (Qt 5.15.18)
# Project:  student_database.pro
# Template: app
# Command: /usr/bin/qmake -o Makefile student_database.pro
#############################################################################
...
TAR           = tar -cf
COMPRESS      = gzip -9f
DISTNAME      = student_database1.0.0
DISTDIR = /home/nikita/Database/.tmp/student_database1.0.0
LINK          = g++
...
student_database:  $(OBJECTS)  
	$(LINK) $(LFLAGS) -o $(TARGET) $(OBJECTS) $(OBJCOMP) $(LIBS)

Makefile: student_database.pro /usr/lib/qt/mkspecs/linux-g++/qmake.conf /usr/lib/qt/mkspecs/features/spec_pre.prf \
		/usr/lib/qt/mkspecs/common/unix.conf \
		/usr/lib/qt/mkspecs/common/linux.conf \
		/usr/lib/qt/mkspecs/common/sanitize.conf \
		/usr/lib/qt/mkspecs/common/gcc-base.conf \
		...
		/usr/lib/qt/mkspecs/features/yacc.prf \
		/usr/lib/qt/mkspecs/features/lex.prf \
		student_database.pro
	$(QMAKE) -o Makefile student_database.pro
